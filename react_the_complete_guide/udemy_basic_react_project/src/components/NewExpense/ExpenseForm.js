...
const ExpenseForm = (props) => {
    ...
    const submitHandler = (event_obj) => {
        ...
        props.onChangeView("defaultView");
    };

    const onAddNewExpenseHandler = (event_obj) => {
        props.onChangeView("selectedView");
    };

    const onCancelHandler = (event_obj) => {
        props.onChangeView("defaultView");
    }


    if (props.desiredView === "defaultView") {
        return (
